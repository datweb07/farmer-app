import { X, Phone, Award, Tag, Eye, Package } from 'lucide-react';
                        ...
                        <div className="max-h-[70vh] overflow-y-auto">
                            ...
                            <div className="px-6 py-6 space-y-6">
                                ...
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                    <p className="text-sm text-blue-700 font-medium mb-1">Giá bán</p>
                                ...
                                <div className="border-t border-gray-200 pt-6">
                                    ...
                                    <div className="flex items-center justify-between bg-gray-50 rounded-lg p-4">
                                        <div>
                                            <p className="text-sm text-gray-600 mb-1">Tên người bán</p>
                                ...
                                <div className="border-t border-gray-200 pt-6">
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4 mb-4">
                                        ...
                                        <p className="text-lg font-medium text-gray-900">{product.contact}</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-gray-50 border-t border-gray-200 px-6 py-4">
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors"
                                >
